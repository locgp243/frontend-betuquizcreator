...
import { LoginUser, postRegisterUser } from "../../services/apiServices";
...
const Register = () => {
  ...
  const handleRegister = async () => {
    let res = await postRegisterUser(password, email);
      ...
      <div className="form_container mx-auto">
        <div className="title_container">
          ...
          <span className="subtitle">
            Hãy đăng ký để trải nghiệm các tính năng trong trang web của tôi
          </span>
        </div>
        <br />
